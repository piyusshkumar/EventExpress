...
exports.bookEvent = async (req,res) => {
    ...
    const { eventId, otp } = req.body;
        ...
        if(event.availableSeats <= 0) { return res.status(400).json({message: 'NO AVAILABLE SEATS FOR THIS EVENT'})};
        ...
        res.status(201).json({ message: 'Booking request Submitted. Please proceed to payment.', booking});
    } catch (error) {
